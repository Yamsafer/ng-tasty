  ...
  return {
    ...
    link: function postLink(scope, element, attrs, tastyTable) {
      ...
      setPaginationRanges =  function () {
        ...
        scope.rangePage = x(scope.pagMinRange, scope.pagMaxRange);//$filter('rangeFilter')([], scope.pagMinRange, scope.pagMaxRange);
